...
(Virtually all of the groundwork has been done by Racoda for these userscripts, these are just my custom modifications and maintenance updates)
...
Auction Calculator: Simple script for big auctions when you don't want to do the math yourself, works with main displayer script.
